#pragma once
// =====================================================
// Pixel Gun 3D PC Edition — Offset Definitions
// Source: IL2CPP dump.cs + Cheat Engine live validation
// GameAssembly.dll — IL2CPP compiled game assembly
// =====================================================

namespace Offsets {
  // ==========================================
  // IL2CPP Runtime Export RVAs (from GameAssembly.dll)
  // ==========================================
  namespace IL2CPP {
