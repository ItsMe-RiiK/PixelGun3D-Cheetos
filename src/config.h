#pragma once
// =====================================================
// JSON Config — Save/Load feature settings
// Uses nlohmann/json
// =====================================================
...
namespace Config {
  ...
  inline void SetConfigPath(const std::string& dllPath)
  {
  ...
  inline void Save()
  {
    ...
    j["combat"]["no_spread"]      = Features::bNoSpread;
    ...
    j["weaponmod"]["no_reload"]       = Features::bNoReload;
    ...
    j["playermod"]["invisibility"]     = Features::bInvisibility;
    j["playermod"]["no_fall_damage"]   = Features::bNoFallDamage;
...
#define LOAD_FLOAT(section, key, var) \
  ...
  var = j[section][key].get<float>()
    ...
    LOAD_BOOL("combat", "no_spread", Features::bNoSpread);
    ...
    LOAD_BOOL("visual", "esp_health", Features::bPlayerESPHealth);
    ...
    LOAD_BOOL("weaponmod", "no_reload", Features::bNoReload);
    ...
    LOAD_BOOL("playermod", "invisibility", Features::bInvisibility);
    LOAD_BOOL("playermod", "no_fall_damage", Features::bNoFallDamage);
